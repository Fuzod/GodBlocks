...
import net.ohl.godblocks.entity.animations.ModAnimationDefinitions;
...
public class RhinoModel<T extends Entity> extends HierarchicalModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition mushroom = skull.addOrReplaceChild("mushroom", CubeListBuilder.create().texOffs(8, 7).addBox(-1.0F, -33.0F, -34.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(0, 82).addBox(-3.0F, -35.0F, -36.0F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(3, 84).addBox(-2.0F, -36.0F, -35.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(6, 86).addBox(-1.0F, -37.0F, -34.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 21.0F, 26.0F));
	...
	public void renderToBuffer(@NotNull PoseStack pPoseStack, @NotNull VertexConsumer pBuffer, int pPackedLight, int pPackedOverlay, int pColor) {
		rhino.render(pPoseStack, pBuffer, pPackedLight, pPackedOverlay, pColor);
	}
