...
import net.ohl.godblocks.item.ModArmorMaterials;
...
public class ModArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>())
                    .put(ModArmorMaterials.AMETHYST.get(),
                            new MobEffectInstance(MobEffects.NIGHT_VISION, 300, 1,
    ...
    private void addStatusEffectForMaterial(Player player, ArmorMaterial mapArmorMaterial, MobEffectInstance mapStatusEffect) {
        ...
        // Use this condition if addStatusEffectForMaterial is called somewhere else than evaluateArmorEffects
